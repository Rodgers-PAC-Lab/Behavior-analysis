...
# Checks mouse_names against cohorts and makes sure they have the same subjects. A mouse cannot be in multiple cohorts.
...
# Calculate trial duration in seconds and add it as a column on trial_data df
...
# plt.show()
#
# ## This is for examining data from today- not currently used
